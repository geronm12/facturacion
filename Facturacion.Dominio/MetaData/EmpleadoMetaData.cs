...
namespace Facturacion.Dominio.MetaData
{
    public class EmpleadoMetaData : IEntityTypeConfiguration<Emplead>
    {
        public void Configure(EntityTypeBuilder<Emplead> builder)
        {
            ...
            builder.Property(x => x.DNI).HasMaxLength(12).IsRequired();
            builder.Property(x => x.Direccion).HasMaxLength(150).IsRequired();
            builder.Property(x => x.Codigo).IsRequired();
            builder.Property(x => x.Celular).HasMaxLength(100).IsRequired();
            builder.Property(x => x.Apellidos).HasMaxLength(300).IsRequired();
